...
const LandingPage = () => {
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center">
      ...
      {/* Hero Section */}
      <section className="w-full flex flex-col items-center py-16 px-6 bg-gradient-to-b from-blue-500 to-blue-700 text-white text-center">
        <h2 className="text-4xl font-bold mb-4">Unlock Market Insights with Ease</h2>
        <p className="max-w-md text-lg">
          MarketInsyte brings you the latest data-driven insights to help your business thrive. Discover trends, analyze
          markets, and make informed decisions with ease.
        </p>
        <button className="mt-8 px-6 py-3 bg-yellow-400 text-blue-800 rounded-full font-semibold hover:bg-yellow-500">
          Get Started
        </button>
      </section>
